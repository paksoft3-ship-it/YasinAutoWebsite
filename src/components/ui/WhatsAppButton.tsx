...
export default function WhatsAppButton({ 
  ...
  const variants = {
    primary: 'bg-success-green text-white px-8 py-4 text-lg hover:bg-success-green-dark shadow-lg',
    secondary: 'border-4 border-success-green text-success-green px-8 py-4 text-lg hover:bg-success-green hover:text-white',
    mega: 'border-4 border-lime-400 text-lime-400 px-12 py-6 text-2xl hover:bg-lime-400 hover:text-gray-900 shadow-2xl',
  };
  ...
  return (
    ...
    >
      ...
      {children || (variant === 'mega' ? 'WHATSAPP' : 'WA')}
    </a>
  );
}
